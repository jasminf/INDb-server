...
class ArtistStats {
    ...
    _buildReport(albums) {
        return {
                totalAverageDuration: this._calcTotalAverage(albums, DURATION_FIELD),
                    albumAveragesDuration: this._calcAvgTrackPerAlbum(albums, DURATION_FIELD),

                    totalAverageRank: this._calcTotalAverage(albums, RANK_FIELD),
                    albumAveragesRank: this._calcAvgTrackPerAlbum(albums, RANK_FIELD),
                }
    };
            // duration: {
